...
const Blogs = () => {
    return (
        ...
        Semantic tag হলো এমন কতগুলো tag । যাদের কত গুলো নির্দিষ্ট মিনিং আছে HTML page এর কছে, ব্রাউজার এর কাছে ও গুগল বট এর কাছে । যে tag গুলো দারা এরা বুঝতে পারে যে ওই tag এর ভিতর কি আছ । যেমন :-
         header একটা semantic tag . HTMl page , google bot এরা বুঝতে পারে  যে এটা website এর হেড  এর অংশ । আবার footer একটা ‍ semantic tag এটা দ্বারা বুঝা যায় যে এটা একটা website এর  footer এর অংশ । এই semantic tag গুলো ‍ SEO করার জন্যে ভালো কাজে লাগে । আমরা যদি header tag এর যায়গায় header tag use না করে div use করি তবুও কাজ করবে বাট HTML page বঝতে পারবে না যে এটা header na others content .
            </div>
